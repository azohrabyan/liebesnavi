...
class JoinForm
{
    public static function step1()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Username(t('Username:'), 'username', array('placeholder' => t('Username'), '<span class="username"></span></strong>' . PH7_PAGE_EXT, 'id' => 'username', 'required' => 1, 'validation' => new \PFBC\Validation\Username)));
