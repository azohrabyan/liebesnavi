...
class MailForm
{
	...
	$maxMessageLength = DbConfig::getSetting('maxMessageLength');
        ...
        $oForm->addElement(new \PFBC\Element\Textarea(t('Your message: '), 'message', array('id' => 'str_msg', 'onblur' => 'CValid(this.value,this.id,2,'.$maxMessageLength.')', 'value' => $oHttpRequest->get('message'), 'validation' => new \PFBC\Validation\Str(2, $maxMessageLength), 'basic' => 1, 'required' => 1)));
