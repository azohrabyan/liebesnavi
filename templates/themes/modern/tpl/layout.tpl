    ...
    <div role="main" class="container" id="content">
      ...
      <div class="msg"></div>
        <div id="messenger">
            ...
            <div class="messenger_user_info"></div>
            <div class="messenger_chat_content_container">

            </div>
            <div class="messenger_chat_send">
                {*<textarea class="messenger_textarea messenger_textareaselected"*}
